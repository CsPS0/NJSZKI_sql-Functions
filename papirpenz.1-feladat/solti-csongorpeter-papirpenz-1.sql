...
-- 6. feladat
SELECT `penznem`, `ertek` FROM `papirpenz` GROUP BY `penznem`, `ertek`ORDER BY `penznem`, `ertek`;
-- 7. feladat
...
-- 10. feladat
SELECT * FROM `papirpenz` ORDER BY `ertek` ASC LIMIT 1;
-- 11. feladat
SELECT * FROM `papirpenz` ORDER BY `ertek` DESC LIMIT 1;
-- 12. feladat
